...
//        String data = "think02";
//        String data = "jdbc:sqlserver://192.168.0.131:1433;database=pay_20171127";
        String data = "jdbc:sqlserver://172.12.33.21:1433;database=sgssz";
//        String data = "sa";
//        String data = "Mzmt123456";
//        String data = "Zmt0.123456789";
        String encryptData = encrypt(data);
        System.out.println("加密后数据：" + encryptData);
        System.out.println("解密后数据：" + decrypt(encryptData));
        System.out.println("解密后数据：" + decrypt("V7/4JQ3ayuD7GIO5brVUKNi8oo/6jmO9+RSaHCHOd8eAvbg5yIHSYg0IV6B29OakBBqZU/nq5KXaztu4JcXguw=="));
        System.out.println("解密后数据：" + decrypt("V7/4JQ3ayuD7GIO5brVUKMJudGduggCCigcSNJiUVzI9rbcWSMriVmJSO7/+fOwF"));
    }
}
