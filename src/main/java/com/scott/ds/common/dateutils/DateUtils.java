...
public class DateUtils {
    ...
    public static void main(String[] args) {
        System.out.println("当前时间：" + getDateByType(DateParttern.getDateType(5)));
        System.out.println("当前时间：" + getCurrentTime());
        System.out.println("今天开始时间：" + getCurrentTimeDate());
        System.out.println("本周开始时间：" + getCurrentTimeWeekMonday());
        System.out.println("本月开始时间：" + getCurrentTimeMonthFirst());
    }
    ...
    /**
     * 获得当前日期 今天的时间 yyyy-MM-dd HH:mm:ss
     */
    ...
    /**
     * 获得当前周周一的时间  yyyy-MM-dd HH:mm:ss.SSS
     */
    public static String getCurrentTimeWeekMonday() {
        // 小写的hh取得12小时，大写的HH取的是24小时
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        Date date = getThisWeekMonday(new Date());
        return df.format(date)+" 00:00:00.000";
    }

    /**
     * 获得当前月第一天的时间  yyyy-MM-dd HH:mm:ss.SSS
     */
    public static String getCurrentTimeMonthFirst() {
        // 小写的hh取得12小时，大写的HH取的是24小时
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        Date date = getmindate();
        return df.format(date)+" 00:00:00.000";
    }
